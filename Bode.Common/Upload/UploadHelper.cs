...
namespace Bode.Common.Upload
{
    public static class UpLoadHelper
    {
        ...
        /// <param name="afterPath">类似：aaaa/bbb/子文件夹</param>
        /// <returns></returns>
        public static List<string> ApiUploadZip(HttpFileCollection hfc, string afterPath = "")
        {
            string path = string.Format("{0}{1}/", UploadRoot, afterPath);
